...
class Google_Service_QPXExpress_PricingInfo extends Google_Collection
{
  ...
  public function setLatestJobingTime($latestJobingTime)
  {
    $this->latestJobingTime = $latestJobingTime;
  }
  public function getLatestJobingTime()
  {
    return $this->latestJobingTime;
  }
