  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <?php echo form_open_multipart(site_url("jobs/add_category_pro"), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="checkbox" name="no_jobs" value="1">
   ...
   var st = $('#search_type').val();
    var table = $('#cat-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("jobs/cat_page") ?>",
            type : 'GET',
            data : function ( d ) {
