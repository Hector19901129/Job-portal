                ...
                <div class="media" style="overflow: visible !important; margin: 0 auto;">
                    <div style="width: 100%;margin: auto;">
                        <?php foreach($files->result() as $file){ ?>
                            <iframe src="http://docs.google.com/viewer?url=https://scportal.com.au/uploads/<?php echo $file->upload_file_name ?>&embedded=true" style="border: none;height:90vh;width:inherit !important"></iframe>
                        <?php } ?>
                    </div>
                </div>
            </div>
