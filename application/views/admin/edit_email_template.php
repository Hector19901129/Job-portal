...
<div class="form-group">
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        <option value="job_reply" <?php if($email_template->hook == "job_reply") echo "selected" ?>><?php echo lang("ctn_708") ?></option>
                        <option value="job_creation" <?php if($email_template->hook == "job_creation") echo "selected" ?>><?php echo lang("ctn_709") ?></option>
                        <option value="guest_job_creation" <?php if($email_template->hook == "guest_job_creation") echo "selected" ?>><?php echo lang("ctn_710") ?></option>
                        <option value="job_reminder" <?php if($email_template->hook == "job_reminder") echo "selected" ?>><?php echo lang("ctn_711") ?></option>
                        </select>
