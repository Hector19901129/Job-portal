          ...
          <div class="form-group">
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        <option value="job_reply"><?php echo lang("ctn_708") ?></option>
                        <option value="job_creation"><?php echo lang("ctn_709") ?></option>
                        <option value="guest_job_creation"><?php echo lang("ctn_710") ?></option>
                        <option value="job_reminder"><?php echo lang("ctn_711") ?></option>
                        </select>
