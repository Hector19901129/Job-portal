...
<?php echo form_open_multipart(site_url("jobs/edit_category_pro/" . $category->ID), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="checkbox" name="no_jobs" value="1" <?php if($category->no_jobs) echo "checked" ?>>
