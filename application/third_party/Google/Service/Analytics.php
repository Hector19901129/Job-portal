...
class Google_Service_Analytics extends Google_Service
{
  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->provisioning = new Google_Service_Analytics_Provisioning_Resource(
        ...
        array(
          'methods' => array(
            'createAccountJob' => array(
              'path' => 'provisioning/createAccountJob',
              'httpMethod' => 'POST',
              'parameters' => array(),
            ),
          )
...
class Google_Service_Analytics_Provisioning_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates an account job. (provisioning.createAccountJob)
   *
   * @param Google_AccountJob $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_Analytics_AccountJob
   */
  public function createAccountJob(Google_Service_Analytics_AccountJob $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('createAccountJob', array($params), "Google_Service_Analytics_AccountJob");
  }
}
...
class Google_Service_Analytics_AccountJob extends Google_Model
{
  protected $internal_gapi_mappings = array(
  );
