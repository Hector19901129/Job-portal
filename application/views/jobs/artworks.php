...
<div class="db-header clearfix">
    ...
    <div class="form-group" style="display:none"><span style="padding-right: 7px;padding-left: 12px;">Show All:</span><input type="checkbox" onchange="checkShowAll(this)" name="showall" <?php echo $showall != 0 ? "checked" : ''?>></div>
    <div class="form-group" style="display:none"><span style="padding-right: 7px;padding-left: 12px;">Print All:</span><input type="checkbox" onchange="checkPrintAll(this)" name="printall" <?php echo $printall != 0 ? "checked" : ''?>></div>
    
    <div class="form-group" style="display:none"><a href="<?php echo site_url("jobs/print_viewall/") ?>" class="btn btn-default btn-xs" style="margin: 0px 5px 0px 5px;" data-toggle="tooltip" data-placement="right" title="<?php echo lang("ctn_632") ?>"><span class="glyphicon glyphicon-print"></span></a></div>
      <?php } ?>
...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
     ...
     <a href="<?php echo site_url("jobs/add_artwork") ?>" class="btn btn-primary btn-sm"><?php echo "Add New Artwork" ?></a>
</div>
</div>
...
<thead>
      <tr class="table-header"><td><?php echo lang("ctn_611") ?></td><td><?php echo lang("ctn_11") ?></td><td><?php echo lang("ctn_391") ?></td><td><?php echo lang("ctn_481") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
...
$(document).ready(function() {
   ...
   var st = $('#search_type').val();
    var table = "<?php echo $page?>" == "artworks" ? $('#job-table').DataTable({
