...
<?php endif; ?>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <hr>
        <p class="align-center small-text"><?php echo lang("ctn_170") ?> <a href="https://www.lotfibentaleb.com/">Lotfi Ben Taleb</a><br /> <?php echo $this->settings->info->site_name ?> V<?php echo $this->settings->version ?> - <a href="<?php echo site_url("home/change_language") ?>"><?php echo lang("ctn_171") ?></a></p>
