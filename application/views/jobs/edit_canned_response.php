...
<div class="db-header clearfix">
    ...
    <a href="<?php echo site_url("jobs/add_canned_response") ?>" class="btn btn-primary btn-sm"><?php echo lang("ctn_568") ?></a>
</div>
</div>
...
<?php echo form_open(site_url("jobs/edit_canned_response_pro/" . $canned->ID), array("class" => "form-horizontal")) ?>
