...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_611") ?></td><td><?php echo lang("ctn_389") ?></td><td><?php if(in_array('10', explode(",", $user_field))) echo lang("ctn_739"); ?></td><td><?php if(in_array('9', explode(",", $user_field))) echo lang("ctn_740"); ?></td><!-- <td><?php echo lang("ctn_428") ?></td> --><td><?php echo lang("ctn_391") ?></td><!-- <td><?php //echo lang("ctn_462") ?></td> --><td><?php echo lang("ctn_463") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
