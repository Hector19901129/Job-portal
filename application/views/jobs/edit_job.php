...
<?php echo form_open_multipart(site_url("jobs/edit_job_pro/" . $job->ID), array("class" => "form-horizontal")) ?>
        ...
        <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control" name="client" id="username-search" placeholder="<?php echo lang("ctn_559") ?>" value="<?php echo $job->client_username ?>">
                </div>
        </div>
        <?php if($this->settings->info->enable_job_guests) : ?>
            <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="guest_email" value="<?php echo $job->guest_email ?>">
        ...
        <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control" name="assigned" id="username-search2" placeholder="<?php echo lang("ctn_559") ?>" value="<?php echo $job->username ?>">
                </div>
        </div>
        <div class="form-group">
                ...
                <div class="col-md-4 ui-front">
                    ...
                    <option value="1" <?php if($job->priority == 1) echo "selected" ?>><?php echo lang("ctn_430") ?></option>
                    <option value="2" <?php if($job->priority == 2) echo "selected" ?>><?php echo lang("ctn_431") ?></option>
                    <option value="3" <?php if($job->priority == 3) echo "selected" ?>><?php echo lang("ctn_432") ?></option>
                    </select>
                </div>
        </div>
        <div class="form-group">
                <label for="p-in" class="col-md-3 label-heading"><?php echo lang("ctn_563") ?></label>
                <div class="col-md-4 ui-front">
                    <select name="status" class="form-control">
                    <option value="0"><?php echo lang("ctn_465") ?></option>
                    <option value="1" <?php if($job->status == 1) echo "selected" ?>><?php echo lang("ctn_466") ?></option>
                    <option value="2" <?php if($job->status == 2) echo "selected" ?>><?php echo lang("ctn_467") ?></option>
                ...
                <div class="col-md-9 ui-front">
                    <select name="catid" id="parent_cat" class="form-control">
                        ...
                        <?php foreach($categories->result() as $r) : ?>
                            <option value="<?php echo $r->ID ?>" <?php if($r->ID == $job->categoryid) echo "selected" ?> <?php if($r->ID == $job->cat_parent) echo "selected" ?>><?php echo $r->name ?></option>
                        <?php endforeach; ?>
                    </select>
                    <div id="sub_cats"><?php if($sub_cats) : ?>
                        ...
                        <select name="sub_catid" id="sub_cat" class="form-control">
                            ...
                            <?php foreach($sub_cats->result() as $r) : ?>
                                <option value="<?php echo $r->ID ?>" <?php if($r->ID == $job->categoryid) echo "selected" ?>><?php echo $r->name ?></option>
                            <?php endforeach; ?>
                        </select>
                        <?php endif; ?>
                    </div>
        ...
        <div class="form-group">
                ...
                <div class="col-md-9 ui-front">
                    <textarea name="body" id="job-body"><?php echo $job->body ?></textarea>
                </div>
        </div>
        <div class="form-group yellow-bg">
                <label for="p-in" class="col-md-3 label-heading"><?php echo lang("ctn_564") ?></label>
                <div class="col-md-9 ui-front">
                    <textarea name="notes" id="job-notes"><?php echo $job->notes ?></textarea>
