    ...
    <body>
        ...
        <div class="media" style="overflow: visible !important;">
          ...
          <div class="media-body" style="overflow: visible !important;">
            ...
            <p><?php echo lang("ctn_468") ?>: <?php if(isset($job->client_username)) : ?><a href="<?php echo site_url("profile/" . $job->client_username) ?>"><?php echo $job->client_username ?></a> <?php else : ?> <?php echo lang("ctn_469") ?>: <?php echo $job->guest_email ?><?php endif; ?></p>
            ...
            <p><?php echo lang("ctn_471") ?>: <?php echo date($this->settings->info->date_format, $job->last_reply_timestamp) ?> <?php if(isset($job->lr_username)) : ?><?php echo lang("ctn_602") ?> <a href="<?php echo site_url("profile/" . $job->lr_username) ?>"><?php echo $job->lr_username ?></a><?php endif; ?> </p>

            <p><?php echo lang("ctn_603") ?>: <?php if(isset($job->username)) : ?><a href="<?php echo site_url("profile/" . $job->username) ?>"><?php echo $job->username ?></a><?php else : ?><?php echo lang("ctn_46") ?> <a href="<?php echo site_url("jobs/assign_user/" . $job->ID . "/" . $this->security->get_csrf_hash()) ?>" class="btn btn-primary btn-xs"><?php echo lang("ctn_604") ?></a><?php endif; ?></p>
            <p><?php echo lang("ctn_462") ?>: <a href=""><?php echo $job->cat_name ?></a></p>
            <?php if($this->common->has_permissions(array("admin", "job_manager", "job_worker"), $this->user)) : ?>

          <p>Job Status: <?php echo $statuses[$job->status] ?></p>
          <?php if($this->settings->info->job_rating) : ?>
          <p>TIcket Rating: <?php echo $job->rating ?></p>
      <?php endif; ?>
            <hr>
          <?php endif; ?>
