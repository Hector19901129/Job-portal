...
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_619") ?></label>
    <div class="col-sm-10">
        <input type="text" class="form-control" id="dpname-in" name="avatar_height" placeholder="" value="<?php echo $this->settings->info->avatar_height ?>" ><br />
        <span class="help-block"><?php echo lang("ctn_620") ?></span>
    </div>
</div>
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_621") ?></label>
    <div class="col-sm-10">
        <input type="text" class="form-control" id="dpname-in" name="avatar_width" placeholder="" value="<?php echo $this->settings->info->avatar_width ?>" ><br />
        <span class="help-block"><?php echo lang("ctn_622") ?></span>
    </div>
</div>
<div class="form-group">
