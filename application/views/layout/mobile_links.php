<div id="responsive-menu-links">
          ...
          <?php if($this->user->loggedin && isset($this->user->info->user_role_id) && 
           ...
           <?php if($this->user->info->admin || $this->user->info->admin_settings) : ?>
            ...
            <option value='<?php echo site_url("admin/job_settings") ?>'><?php echo lang("ctn_524") ?></option>
            <?php endif; ?>
          ...
          <?php endif; ?>
            ...
            <option value='<?php echo site_url("jobs") ?>'><?php echo lang("ctn_528") ?></option>
            <?php endif; ?>
            <?php if($this->common->has_permissions(array("admin", "job_manager", "job_worker"), $this->user)) : ?>
            <option value='<?php echo site_url("jobs/your") ?>'><?php echo lang("ctn_529") ?></option>
            <option value='<?php echo site_url("jobs/assigned") ?>'><?php echo lang("ctn_530") ?></option>
            <option value='<?php echo site_url("jobs/custom_views") ?>'><?php echo lang("ctn_627") ?></option>
            <?php endif; ?>
            <?php if($this->common->has_permissions(array("admin", "job_manager"), $this->user)) : ?>
            <option value='<?php echo site_url("jobs/categories") ?>'><?php echo lang("ctn_531") ?></option>
            <option value='<?php echo site_url("jobs/custom_fields") ?>'><?php echo lang("ctn_532") ?></option>
            <option value='<?php echo site_url("jobs/canned_responses") ?>'><?php echo lang("ctn_533") ?></option>
            <?php endif; ?>
