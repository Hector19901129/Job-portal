...
<div class="row">
<div class="col-md-6">
<?php echo form_open(site_url("jobs/merge_job_pro/" . $job->ID), array("class" => "form-horizontal")) ?>
<h4><?php echo lang("ctn_719") ?></h4>
<p>Job: <a href=""><?php echo $job->title ?></a></p>
...
<tr><td><span class="glyphicon glyphicon-info-sign" data-toggle="tooltip" data-placement="bottom" title="<?php echo lang("ctn_728") ?>"></span> <?php echo lang("ctn_723") ?></td><td><input type="checkbox" name="merge_job" value="1"></td></tr>
...
<div class="form-group">
        ...
        <div class="col-md-8 ui-front">
            <select name="primary_jobid" class="form-control">
...
<div class="form-group">
        ...
        <div class="col-md-8 ui-front">
            <input type="text" name="job_title" id="username-search" class="form-control" placeholder="<?php echo lang("ctn_735") ?> ... ">
...
$(document).ready(function() {
  ...
  $('#username-search').autocomplete({
    ...
    source: function (request, response) {
         $.ajax({
             type: "GET",
             url: global_base_url + "jobs/get_jobs_id",
             data: {
                query : request.term
             },
             dataType: 'JSON',
