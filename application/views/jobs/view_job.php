...
<?php echo $prioritys[$job->priority] ?>
</div>
...
<tr><td colspan="2"><button class="btn btn-default btn-xs" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample"><?php echo lang("ctn_601") ?></button>
  ...
  <tr><td><?php echo lang("ctn_603") ?></td><td> <?php if(isset($job->username)) : ?><a href="<?php echo site_url("profile/" . $job->username) ?>"><?php echo $job->username ?></a><?php else : ?><?php echo lang("ctn_46") ?><?php endif; ?></td></tr>
    <tr><td><?php echo lang("ctn_462") ?></td><td> <a href=""><?php echo $job->cat_name ?></a></td></tr>
...
<div class="dropdown ui-front form-inline">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
    <li><a href="javascript: void(0)" onclick="changeStatus(<?php echo $job->ID ?>,0);"><?php echo lang("ctn_465") ?></a></li>
    <li><a href="javascript: void(0)" onclick="changeStatus(<?php echo $job->ID ?>,1);"><?php echo lang("ctn_466") ?></a></li>
    <li><a href="javascript: void(0)" onclick="changeStatus(<?php echo $job->ID ?>,2);"><?php echo lang("ctn_467") ?></a></li>
    <li><a href="javascript: void(0)" onclick="changeStatus(<?php echo $job->ID ?>,3);">Removed</a></li>
    <li><a href="javascript: void(0)" onclick="changeStatus(<?php echo $job->ID ?>,4);">Completed</a></li>
  </ul>

    <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#assignModal"><?php echo lang("ctn_630") ?></button> <a href="<?php echo site_url("jobs/assign_user/" . $job->ID . "/" . $this->security->get_csrf_hash()) ?>" class="btn btn-primary btn-xs" title="<?php echo lang("ctn_604") ?>" onclick="return confirm('<?php echo lang("ctn_631") ?>')"><span class="glyphicon glyphicon-pushpin"></span></a> <a href="<?php echo site_url("jobs/merge_job/" . $job->ID) ?>" class="btn btn-success btn-xs" data-toggle="tooltip" data-placement="bottom" title="<?php echo lang("ctn_718") ?>"><span class="glyphicon glyphicon-transfer"></span></a> <a href="<?php echo site_url("jobs/print_view/" . $job->ID) ?>" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="right" title="<?php echo lang("ctn_632") ?>"><span class="glyphicon glyphicon-print"></span></a> <a href="<?php echo site_url("jobs/notify_job/" . $job->ID . "/" . $this->security->get_csrf_hash()) ?>" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="right" title="<?php echo lang("ctn_673") ?>"><span class="glyphicon glyphicon-bullhorn"></span></a> <a href="<?php echo site_url("jobs/edit_job/" . $job->ID) ?>" class="btn btn-warning btn-xs" data-toggle="tooltip" data-placement="right" title="<?php echo lang("ctn_55") ?>"><span class="glyphicon glyphicon-cog"></span></a> <a href="<?php echo site_url("jobs/delete_job/" . $job->ID . "/" . $this->security->get_csrf_hash()) ?>" class="btn btn-danger btn-xs" onclick="return confirm('<?php echo lang("ctn_317") ?>')" data-toggle="tooltip" data-placement="right" title="<?php echo lang("ctn_57") ?>"><span class="glyphicon glyphicon-trash"></span></a>
</div>
